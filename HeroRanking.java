...
public class HeroRanking {
    /**
     * 
     * @param Reputation - reputation is used to determine the herorank of the user in the game
     * @return - The_HERO_RANK that is used to be printed out as the users herorank and is
     *  not changeable 
     */
