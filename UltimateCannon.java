...
public class UltimateCannon {
    ...
    /**
     * @LuisD.Hernandez
     * @param userAnswer - accepts the parameter to be used in if statement and gives an output
     * @param Reputation - reputation is changed depending on the answer provided
     * @param userName -method accepts parameter to be used to printed out at the end
