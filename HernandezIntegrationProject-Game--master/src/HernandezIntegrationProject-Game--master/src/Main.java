...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // these skills will increment or decrement with activities that happen
        // in the code
        Random randomSkill = new Random();
        // i love VanSelow and chocolates
        ...
        //ArrayFunction.projectArray(Strength, Agility, Intelligence, Stamina);
        // this method will be called at the end so the user sees how their stats have changed from
        //the beginning
